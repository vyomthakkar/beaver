...
def extract_dynamic_document(file_path, schema_model_class):
    ...
    file_ref = client.files.upload(file=input_text_path, config=types.UploadFileConfig(mime_type="text/plain"))
    # file_ref = client.upload_file(
    #         path=file_path,
    #         mime_type="text/plain",
    #         display_name=file_path # Optional: A friendly name for the file
    #     )
